...
El dataset `Telecom-analysis` incluye mas de 20,000 tipos de valores faltantes, sentinels, outliers y problemas de calidad diseñados para simular datos reales del retail. 
